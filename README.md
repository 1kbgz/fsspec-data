...
- [Convert tabular data](./docs/tutorial.md) in a
  guided first example.
- [Connect a batch producer or consumer](./docs/how-to-integrate.md)
  to the interchange layer.
- [Convert a file through an fsspec chain](./docs/how-to-chain-filesystems.md)
  while retaining its source filesystem.
- [Understand the interchange design](./docs/explanation.md)
  and package boundaries.
- [Look up the interchange API](./docs/api.md),

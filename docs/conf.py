...
# -*- coding: utf-8 -*-
#
# fsspec_data documentation build configuration file, created by
...
htmlhelp_basename = "fsspec_datadoc"
...
man_pages = [(master_doc, "fsspec_data", "fsspec_data Documentation", [author], 1)]
...
def run_apidoc(_):
    ...
    fsspec_data_dir = os.path.abspath(
        os.path.join(os.path.dirname(__file__), "..", "fsspec_data")
    )
    ...
    subprocess.check_call(
        [cmd_path, "-E", "-M", "-o", out_dir, fsspec_data_dir, "--force"]
    )
